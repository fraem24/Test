...
/**
 ******************************************************************************
  * @file    user_diskio_sd.c
  * @brief   This file contains the implementation of the user_diskio_sd FATFS
  *          driver.
  ******************************************************************************
  * Copyright (C) 2021, M. Fränzl, All Rights Reserved.
  *
...
// an SD or MMC card connected via SPI with FAT.
...
// Set #define SD_SPI_HANDLE as some hspiX in main.h
// Set #define SD_CS_GPIO_Port as some GPIO port in main.h
// Set #define SD_CS_Pin as some GPIO pin in main.h
...
inline DSTATUS USER_SD_initialize (
...
)
{
	...
	case CTRL_TRIM :	/* Erase a block of sectors (used when _USE_ERASE == 1) */
		...
		if (USER_SD_ioctl(drv, MMC_GET_CSD, csd)) break;	/* Get CSD */
